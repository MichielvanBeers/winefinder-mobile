...
// Wine type
import { Wine, Grape } from "./wine.interface";
...
export const wineApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getAllGrapes: builder.query<Grape[], void>({
      query: () => "/wines/grapes/",
    })
  }),
});

export const { useLazyGetAllWinesQuery, useAddWineMutation, useLazyGetAllGrapesQuery } = wineApi;
